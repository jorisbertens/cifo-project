...
def algo_run(seed, n_gen, p_c, p_m, radius, pressure):
    ...
    #++++++++++++++++++++++++++
    alg = GeneticAlgorithm(ann_op_i, random_state, pop_size, sel.boltzmann_selection(pressure, n_gen),
                      cross.parameterized_uniformSwap(0.25), p_c, mut.parametrized_random_member_mutation(radius, (-2,2)), p_m)
    alg.initialize()
