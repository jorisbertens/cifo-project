...
from ga_zeros_initialization import GeneticAlgorithmZerosInitialization
# setup logger
# !!!!!!!!!!!!!!!!!!!!!Change file name !!!!!!!!!!!!!!!!!!!!!!!!!!!1
...
def algo_run(seed, n_gen, p_c, p_m, radius, pressure, elite_count):
    ...
    alg = GeneticAlgorithmZerosInitialization(ann_op_i, random_state, pop_size, sel_algo,
