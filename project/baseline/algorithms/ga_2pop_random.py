...
class GeneticAlgorithm2Random(RandomSearch):
    ...
    def search(self, n_iterations, report=False, log=False):
        ...
        for iteration in range(n_iterations):
            ...
            elites2 = self._get_x_elites(offsprings2,1)

            print("Elite 1 fitness:")
            print(self._get_elite(offsprings1).fitness)

            print("Elite 2 fitness:")
            print(self._get_elite(offsprings2).fitness)

            if self._get_elite(offsprings1).fitness > self._get_elite(offsprings2).fitness:
                print("Random crossover")
            else:
                print("Mutation of elites")

            offsprings1.extend(elites2)
            offsprings2.extend(elites1)
